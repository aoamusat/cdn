    ...
    (function (t) {
        t.HSCore.components.HSValidation = {
            ...
            init: function (e, s) {
                if (e.length) {
                    var a = Object.assign({}, this.defaults),
                        i = e.attr("data-hs-validation-options")
            ...
            highlight: function (e) {
                var s = t(e),
                    a = s.data("error-class")
                        ? s.data("error-class")
                        : "is-invalid",
                    i = s.data("success-class")
                        ? s.data("error-class")
                        : "is-valid",
                    n = s.parents(".js-form-message").first(),
                    o = s;
                void 0 !== n.data("validate-state")
                    ? (o = n)
                    : n.find("[data-validate-state]").length &&
                      (o = n.find("[data-validate-state]")),
        ...
        t.HSCore.components.HSSelect2 = {
            ...
            init: function (e, s) {
                if (e.length) {
                    var a = this,
                        ...
                        n = e.attr("data-hs-select2-options")
                ...
                let i = t(e).next(".select2").find(".select2-selection"),
                    n =
                        e.find(":selected").length > 0
                            ? a.singleMultiplePrefix +
                              e.find(":selected").length +
                              a.singleMultiplePostfix
                            : a.placeholder;
                i.removeClass("select2-selection--multiple"),
                    e.find(":selected").length > 0
                        ? i.addClass(a.singleMultipleActiveClass)
                        : i.removeClass(a.singleMultipleActiveClass),
                    i
            ...
            formatData: function (e) {
                var s,
                    a = e;
                return a.element
                    ? ((s = a.element.dataset.optionTemplate
                          ? a.element.dataset.optionTemplate
                          : "<span>" + a.text + "</span>"),
                      t.parseHTML(s))
                    : a.text;
            },
            ...
            searchPlaceholder: function (e, s) {
                ...
                e.on("select2:open", function () {
                    t(".select2-container--open .select2-search__field")
                        .last()
                        .attr("placeholder", a.searchInputPlaceholder);
                });
            },
        };
    })(jQuery),
        ...
        t.HSCore.components.HSMask = {
            ...
            init: function (e, s) {
                if (e.length && void 0 !== e.attr("data-hs-mask-options")) {
                    var a = Object.assign({}, this.defaults),
                        i = e.attr("data-hs-mask-options")
                            ? JSON.parse(e.attr("data-hs-mask-options"))
                            : {},
                        n = {};
                    return (
                        (n = t.extend(!0, a, n, i, s)), e.mask(n.template, n)
                    );
                }
            },
        };
            ...
            init: function (e, s) {
                if (t(e).length) {
                    var a = t(e),
                        ...
                        n = a.attr("data-hs-quill-options")
                            ? JSON.parse(a.attr("data-hs-quill-options"))
                            : {},
                        o = {};
                    return (o = Object.assign({}, i, o, n, s)), new Quill(e, o);
                }
            },
        };
    })(jQuery),
        ...
        t.HSCore.components.HSClipboard = {
            ...
            init: function (e, s) {
                if (t(e).length) {
                    var a = t(e),
                        i = Object.assign({}, this.defaults),
                        n = a.attr("data-hs-clipboard-options")
                            ? JSON.parse(a.attr("data-hs-clipboard-options"))
                            : {},
                        o = {
                            shortcodes: {},
            ...
            setShortcodes: function (e, s) {
                var a = s;
                t(a.contentTarget).is("input, textarea, select")
                    ? (a.shortcodes[a.contentTarget] = t(a.contentTarget).val())
                    : (a.shortcodes[a.contentTarget] = t(
                          a.contentTarget,
                      ).html());
            },
        };
        ...
        t.HSCore.components.HSSlickCarousel = {
            ...
            init: function (e, s) {
                if (e.length) {
                    var a = this,
                        i = Object.assign({}, a.defaults),
                        n = e.attr("data-hs-slick-carousel-options")
                            ? JSON.parse(
                                  e.attr("data-hs-slick-carousel-options"),
                              )
                            : {},
                        o = { id: e.attr("id") };
                    (o = t.extend(i, o, n)),
                            ...
                            o,
                            {
                                customPaging: function (e, s) {
                                    ...
                                    return a && o.dotsWithIcon
                                        ...
                                        ? "<span>" + a + "</span>"
                                        : a && !o.dotsFromTitles
                                        ? '<span></span><strong class="dot-title">' +
                                          a +
                                          "</strong>"
                                        : "<span></span>";
                                },
                    ...
                    return (
                        t(o.asNavFor)[0] &&
                            t(o.asNavFor)[0].dataset.hsSlickCarouselOptions &&
                            JSON.parse(
                                t(o.asNavFor)[0].dataset.hsSlickCarouselOptions,
                            ).isThumbsProgress &&
                            a.setInitialDelay(e, o),
                        e.on("beforeChange", function (t, s, i, n) {
                            a.setCustomClasses(e, t, s, i, n);
                        }),
                        o.counterSelector &&
                            e.on("beforeChange", function (t, e, s, i) {
                        ...
                        o.animationIn &&
                            o.animationOut &&
                            (e.on("afterChange", function (t, e, s, i) {
            ...
            transformOff: function (e, s, a, i) {
                ...
                t(i.$slides).css("height", "auto"),
                    n.isThumbs &&
                        n.slidesToShow >= t(i.$slides).length &&
                        e.addClass("slick-transform-off");
            },
                ...
                s.$slides.each(function (e) {
                    ...
                    t(i).each(function () {
                        var e = t(this).data("hs-slick-carousel-animation"),
                            s = t(this).data(
                                "hs-slick-carousel-animation-delay",
                            ),
                            a = t(this).data(
            ...
            goToTargetSlide: function (e, s) {
                ...
                t("#" + a.id).slick("slickCurrentSlide") !== i &&
                    t("#" + a.id).slick("slickGoTo", i);
            },
            ...
            setCounter: function (e, s, a) {
                var i = e;
                t(i.counterSelector).html(
                    '<span class="' +
                        i.counterClassMap.current +
                        '">1</span><span class="' +
                        i.counterClassMap.divider +
                        '">' +
                        i.counterDivider +
                        '</span><span class="' +
                        i.counterClassMap.total +
                        '">' +
                        a.slideCount +
                        "</span>",
                );
            ...
            setCustomClasses: function (e, s, a, i, n) {
                ...
                t(c).each(function () {
                    ...
                    l.length &&
                        (i > n
                            ? (t(l[0].children).removeClass(
                                  "slick-active-right",
                              ),
                              t(l[0].children[n]).addClass(
                                  "slick-active-right",
                              ))
                            : t(l[0].children).removeClass(
                                  "slick-active-right",
            ...
            setPosition: function (e, s, a) {
                var i = e;
                t(a.$slides[a.currentSlide]).addClass(
                    "animated set-position " + i.animationIn,
                );
            },
            counting: function (e, s, a, i, n) {
                ...
                t(o.counterSelector).html(
                    '<span class="' +
                        o.counterClassMap.current +
                        '">' +
                        r +
                        '</span><span class="' +
                        o.counterClassMap.divider +
                        '">' +
                        o.counterDivider +
                        '</span><span class="' +
                        o.counterClassMap.total +
                        '">' +
                        a.slideCount +
                        "</span>",
                );
            ...
            videoSupport: function (e) {
                e.length &&
                    e.on("beforeChange", function (e, s, a, i) {
                        var n,
                ...
                if (window.TextFx && window.anime && e.length) {
                    ...
                    a.length &&
                        (a.each(function (e, s) {
                            var a = t(s);
                            a.data("TextFx") ||
                                a.data("TextFx", new TextFx(a.get(0)));
                        }),
        ...
        t.HSCore.components.HSCubeportfolio = {
            ...
            init: function (e, s) {
                if (e.length) {
                    var a = t(e),
                        i = Object.assign({}, this.defaults),
                        n = a.attr("data-hs-cbp-options")
                            ? JSON.parse(a.attr("data-hs-cbp-options"))
                            : {},
                        o = {
                    ...
                    return (o = t.extend(i, o, n, s)), e.cubeportfolio(o);
                }
            },
        };
    })(jQuery),
        ...
        t.HSCore.components.HSTyped = {
            ...
            init: function (e, s) {
                if (t(e).length) {
                    var a = t(e),
                        i = Object.assign({}, this.defaults),
                        n = a.attr("data-hs-typed-options")
                            ? JSON.parse(a.attr("data-hs-typed-options"))
                            : {},
                        o = {};
                    return (o = Object.assign({}, i, o, n, s)), new Typed(e, o);
                }
            },
        };
    })(jQuery),
        ...
        t.HSCore.components.HSFancyBox = {
            ...
            init: function (e, s) {
                if (e.length) {
                    var a = t(e),
                        i = Object.assign({}, this.defaults),
                        n = a.attr("data-hs-fancybox-options")
                            ? JSON.parse(a.attr("data-hs-fancybox-options"))
                            : {},
                        o = {
                            beforeShow: function (e) {
                                var s = t(e.$refs.bg[0]),
                                    a = t(e.current.$slide),
                                    i = e.current.opts.$orig[0].dataset
                                        .hsFancyboxOptions
                                        ? JSON.parse(
                                        ...
                                        : {},
                                    n =
                                        !!i.transitionEffectCustom &&
                                        i.transitionEffectCustom,
                                    o = i.overlayBg,
                                    r = i.overlayBlurBg;
                                n && a.css("visibility", "hidden"),
                                    o && s.css({ backgroundColor: o }),
                            ...
                            beforeClose: function (e) {
                                var s = t(e.current.$slide),
                                    a = e.current.opts.$orig[0].dataset
                                        .hsFancyboxOptions
                                        ? JSON.parse(
                                              e.current.opts.$orig[0].dataset
                                                  .hsFancyboxOptions,
                                        ...
                                        : {},
                                    i =
                                        !!a.transitionEffectCustom &&
                                        a.transitionEffectCustom;
                                a.overlayBlurBg;
                                i &&
                                    (s.removeClass(i.onShow).addClass(i.onHide),
                                    t("body").removeClass("fancybox-opened")),
                                    t("body").removeClass("fancybox-blur");
                            },
                        };
                    return (o = t.extend(!0, i, o, n, s)), t(e).fancybox(o);
                }
            },
        };
    })(jQuery),
        ...
        t.HSCore.components.HSIonRangeSlider = {
            ...
            init: function (e, s) {
                if (
                    ...
                    var a = Object.assign({}, this.defaults),
                        i = e.attr("data-hs-ion-range-slider-options")
                            ? JSON.parse(
                        ...
                        n = {
                            onStart: function (e) {
                                if (n.foreground_target_el) {
                                    ...
                                    t(n.foreground_target_el).css({
                                        ...
                                        t(n.foreground_target_el + " > *").css({
                                            width: t(n.foreground_target_el)
                                                .parent()
                                                .width(),
                                            marginLeft:
                                                (-t(n.foreground_target_el)
                                                    .parent()
                                                    .width() /
                                                    100) *
                                                e.from_percent,
                                ...
                                if (
                                    (n.result_min_target_el &&
                                    "single" === n.type
                                        ? t(n.result_min_target_el).is("input")
                                            ? t(n.result_min_target_el).val(
                                                  e.from,
                                              )
                                            : t(n.result_min_target_el).text(
                                                  e.from,
                                              )
                                        : (n.result_min_target_el ||
                                              (n.result_max_target_el &&
                                                  "double" === n.type)) &&
                                          (t(n.result_min_target_el).is("input")
                                              ? t(n.result_min_target_el).val(
                                                    e.from,
                                          ...
                                          t(n.result_min_target_el).is("input")
                                              ? t(n.result_max_target_el).val(
                                                    e.to,
                                                )
                                              : t(n.result_max_target_el).text(
                                                    e.to,
                                                )),
                                    n.grid &&
                                        "single" === n.type &&
                                    ...
                                    n.secondary_val.steps.push(e.max + 1),
                                        n.secondary_val.values.push(
                                            n.secondary_val.values[
                                                n.secondary_val.values.length -
                                                    1
                                            ] + 1,
                                        );
                                    for (
                                        var a = 0;
                                        a < n.secondary_val.steps.length;
                                        a++
                                    )
                                        e.from >= n.secondary_val.steps[a] &&
                                            e.from <
                                                n.secondary_val.steps[a + 1] &&
                                            (t(n.secondary_target_el).is(
                                                "input",
                                            )
                                                ? t(n.secondary_target_el).val(
                                                      n.secondary_val.values[a],
                                                  )
                                                : t(n.secondary_target_el).text(
                                                      n.secondary_val.values[a],
                                                  ));
                                }
                            },
                            onChange: function (e) {
                                ...
                                if (
                                    ...
                                    for (
                                        var i = 0;
                                        i < n.secondary_val.steps.length;
                                        i++
                                    )
                                        e.from >= n.secondary_val.steps[i] &&
                                            e.from <
                                                n.secondary_val.steps[i + 1] &&
                                            (t(n.secondary_target_el).is(
                                                "input",
                                            )
                                                ? t(n.secondary_target_el).val(
                                                      n.secondary_val.values[i],
                                                  )
                                                : t(n.secondary_target_el).text(
                                                      n.secondary_val.values[i],
                                                  ));
                        ...
                        t(n.result_min_target_el).is("input")
                            ...
                            : (n.result_min_target_el ||
                                  (n.result_max_target_el &&
                                      "double" === n.type &&
                                      t(n.result_min_target_el).is("input")) ||
                                  t(n.result_max_target_el).is("input")) &&
                              (t(n.result_min_target_el).on(
                                  "change",
                                  function () {
                                      r.update({ from: t(this).val() });
    ...
    (function (t) {
        t.HSCore.components.HSCircles = {
            ...
            init: function (e, s) {
                if (e.length) {
                    var a = Object.assign({}, this.defaults),
                        i = e.attr("data-hs-circles-options")
                        ...
                        n = {
                            ...
                            value: 0,
                            text: function (t) {
                                return "iconic" === i.type
                                    ? i.icon
                                    : "prefix" === i.additionalTextType
                                    ? i.secondaryText
                                        ? (i.additionalText || "") +
                                          (i.isHideValue ? "" : t) +
                                          '<div style="margin-top: ' +
                                          (i.dividerSpace / 2 + "px" || "0") +
                                          "; margin-bottom: " +
                                          (i.dividerSpace / 2 + "px" || "0") +
                                          ';"></div><div style="font-weight: ' +
                                          i.secondaryTextFontWeight +
                                          "; font-size: " +
                                          i.secondaryTextFontSize +
                                          "px; color: " +
                    ...
                    return (
                        ...
                        n.fgStrokeMiterlimit &&
                            this.setStrokeMiterLimit(e, o, n),
            ...
            initAppear: function (e, s) {
                ...
                appear({
                    ...
                    appear: function (s) {
                        e.update(
                            JSON.parse(t(s).attr("data-hs-circles-options"))
                                .value,
                        );
                    },
                });
    ...
    (function (t) {
        t.HSCore.components.HSLeaflet = {
            ...
            init: function (e, s) {
                if (t(e).length) {
                    var a = t(e),
                        i = a.attr("data-hs-leaflet-options")
                            ? JSON.parse(a.attr("data-hs-leaflet-options"))
                            : {},
                        n = {};
                    n = t.extend(!0, this.defaults, i, n, s);
                    var o = L.map(e, n.map);
                    if (
                        (o.setView(n.map.coords, n.map.zoom),
                        ...
                        for (var r = 0; r < n.marker.length; r++) {
                            ...
                            n.marker[r].popup &&
                                t.bindPopup(n.marker[r].popup.text);
                        }
                    return o;
                }
            },
    ...
    (function (t) {
        t.HSCore.components.HSDropzone = {
            defaults: {
                ...
                thumbnailHeight: 300,
                previewTemplate: t(
                    '<div>  <div class="col test h-100 px-1 mb-2">    <div class="dz-preview dz-file-preview">      <div class="d-flex justify-content-end dz-close-icon">        <small class="fa fa-times" data-dz-remove></small>      </div>      <div class="dz-details media">        <div class="dz-img">         <img class="img-fluid dz-img-inner" data-dz-thumbnail>        </div>        <div class="media-body dz-file-wrapper">         <h6 class="dz-filename">          <span class="dz-title" data-dz-name></span>         </h6>         <div class="dz-size" data-dz-size></div>        </div>      </div>      <div class="dz-progress progress" style="height: 4px;">        <div class="dz-upload progress-bar bg-success" role="progressbar" style="width: 0" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" data-dz-uploadprogress></div>      </div>      <div class="d-flex align-items-center">        <div class="dz-success-mark">          <span class="fa fa-check-circle"></span>        </div>        <div class="dz-error-mark">          <span class="fa fa-times-circle"></span>        </div>        <div class="dz-error-message">          <small data-dz-errormessage></small>        </div>      </div>    </div>  </div></div>',
                ).html(),
            },
            init: function (e, s) {
                if (e.length) {
                    var a = t(e),
                        i = Object.assign({}, this.defaults),
                        n = a.attr("data-hs-dropzone-options")
                            ? JSON.parse(a.attr("data-hs-dropzone-options"))
                            : {},
                        o = {
                            init: function () {
                                var e = this,
                    ...
                    return (
                        "#" ===
                            (o = Object.assign({}, i, o, n, s))
                                .previewTemplate[0] &&
                            (o.previewTemplate = t(o.previewTemplate).html()),
                        new Dropzone(e, o)
                    );
                }
            },
    ...
    (function (t) {
        t.HSCore.components.HSCountdown = {
            ...
            init: function (e, s) {
                if (e.length) {
                    var a = Object.assign({}, this.defaults),
                        i = e.attr("data-hs-countdown-options")
                            ? JSON.parse(e.attr("data-hs-countdown-options"))
                            : {},
                        n = {
                            endDate: i.endDate
                                ? new Date(i.endDate)
                    ...
                    return (
                        ((n = t.extend(!0, a, i, n, s)).yearsEl = e.find(
                            n.yearsElSelector,
                        )),
                        ...
                        n.circles
                            ? this._initPiesImplementation(e, n)
                            : this._initBaseImplementation(e, n)
                    );
                }
            },
            _initBaseImplementation: function (t, e) {
                ...
                return t.countdown(s.endDate, function (t) {
                    console.log(t),
                        s.yearsEl.length &&
                            s.yearsEl.text(t.strftime(s.yearsFormat)),
                        s.monthsEl.length &&
                            s.monthsEl.text(t.strftime(s.monthsFormat)),
                        s.daysEl.length &&
                            s.daysEl.text(t.strftime(s.daysFormat)),
                        s.hoursEl.length &&
                            s.hoursEl.text(t.strftime(s.hoursFormat)),
                        s.minutesEl.length &&
                            s.minutesEl.text(t.strftime(s.minutesFormat)),
                        s.secondsEl.length &&
                            s.secondsEl.text(t.strftime(s.secondsFormat));
                });
            },
            _initPiesImplementation: function (t, e) {
                ...
                return (
                    s.yearsEl.length &&
                        this._preparePieItem(s.yearsEl, {
                            maxValue:
                    ...
                    s.monthsEl.length &&
                        this._preparePieItem(s.monthsEl, {
                            maxValue:
                                Math.round(
                                    Math.abs(
                                        (s.endDate.getTime() -
                    ...
                    s.daysEl.length &&
                        this._preparePieItem(s.daysEl, {
                            maxValue: this._getDaysMaxValByFormat(
                                s.daysFormat,
                                s.startDate,
                                s.endDate,
                            ),
                    ...
                    s.hoursEl.length &&
                        this._preparePieItem(s.hoursEl, {
                            maxValue: 60,
                            radius: s.radius,
                            width: s.strokeWidth,
                            fgColor: s.fgColor,
                    ...
                    s.minutesEl.length &&
                        this._preparePieItem(s.minutesEl, {
                            maxValue: 60,
                            radius: s.radius,
                            width: s.strokeWidth,
                            fgColor: s.fgColor,
                    ...
                    s.secondsEl.length &&
                        this._preparePieItem(s.secondsEl, {
                            maxValue: 60,
                            radius: s.radius,
                            width: s.strokeWidth,
                            fgColor: s.fgColor,
                    ...
                    t.countdown(s.endDate, function (t) {
                        s.yearsEl.length &&
                            s.yearsEl
                                .data("circle")
                                .update(t.strftime(s.yearsFormat)),
                            s.monthsEl.length &&
                                s.monthsEl
                                    .data("circle")
                                    .update(t.strftime(s.monthsFormat)),
                            s.daysEl.length &&
                                s.daysEl
                                    .data("circle")
                                    .update(t.strftime(s.daysFormat)),
                            s.hoursEl.length &&
                                s.hoursEl
                                    .data("circle")
                                    .update(t.strftime(s.hoursFormat)),
                            s.minutesEl.length &&
                                s.minutesEl
                                    .data("circle")
                                    .update(t.strftime(s.minutesFormat)),
                            s.secondsEl.length &&
                                s.secondsEl
                                    .data("circle")
                                    .update(t.strftime(s.secondsFormat));
                    })
                );
            },
            _preparePieItem: function (e, s) {
                ...
                e.data("circle", n),
                    i.fontSize &&
                        e
                            .find("." + n._textClass)
                            .css("font-size", i.fontSize + "px");
            },
            _getDaysMaxValByFormat: function (t, e, s) {
                switch (t) {
                    case "%D":
                        return Math.round(
                            Math.abs((s.getTime() - e.getTime()) / 864e5),
                        );
                    default:
                        return 31;
                }
    ...
    (function (t) {
        t.HSCore.components.HSChartJS = {
            ...
            init: function (e, s) {
                if (e.length) {
                    var a = Object.assign({}, this.defaults),
                        i = e.attr("data-hs-chartjs-options")
                                ...
                                if (Array.isArray(t.backgroundColor)) {
                                    var s = e[0]
                                        ...
                                        .createLinearGradient(
                                            n.options.gradientPosition.x0,
                                            n.options.gradientPosition.y0,
                                            n.options.gradientPosition.x1,
                                            n.options.gradientPosition.y1,
                                        );
                                    for (
                                        let e = 0;
                        ...
                        (o.draw = function (e) {
                            if (
                                ...
                                t("#chartjsTooltip #chartjsTooltipLine")
                                    ...
                                    i.css({
                                        top:
                                            -(a.offset().top - s.offset().top) +
                                            o,
                                    }),
                                    a.offset().left + a.width() >
                                    s.offset().left + s.width() - 100
